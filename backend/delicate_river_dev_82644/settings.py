"""
Django settings for delicate_river_dev_82644 project.
...
ROOT_URLCONF = 'delicate_river_dev_82644.urls'
...
WSGI_APPLICATION = 'delicate_river_dev_82644.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "delicate_river_dev_82644 API",
    "DESCRIPTION": "API documentation for delicate_river_dev_82644 App",
    "VERSION": "v1",
}
